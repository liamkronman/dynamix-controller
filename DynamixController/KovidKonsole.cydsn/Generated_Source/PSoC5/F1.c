...
{
    uint8 staticBits = (F1_DR & (uint8)(~F1_MASK));
    F1_DR = staticBits | ((uint8)(value << F1_SHIFT) & F1_MASK);
}
...
{
	CyPins_SetPinDriveMode(F1_0, mode);
}
...
{
    return (F1_DR & F1_MASK) >> F1_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(F1_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & F1_0_INTR) != 0u) 
		{ 
			 F1_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (F1_INTSTAT & F1_MASK) >> F1_SHIFT;
    }
