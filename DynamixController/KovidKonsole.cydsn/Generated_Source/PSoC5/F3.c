...
{
    uint8 staticBits = (F3_DR & (uint8)(~F3_MASK));
    F3_DR = staticBits | ((uint8)(value << F3_SHIFT) & F3_MASK);
}
...
{
	CyPins_SetPinDriveMode(F3_0, mode);
}
...
{
    return (F3_DR & F3_MASK) >> F3_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(F3_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & F3_0_INTR) != 0u) 
		{ 
			 F3_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (F3_INTSTAT & F3_MASK) >> F3_SHIFT;
    }
