...
#define BS_IOPORT_7_VAL ((const uint8 CYFAR *)0x48000D2Cu)
...
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x48000D68u)

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x48000D70u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG4_CFG0), 0x000Bu);
...
uint8 CYXDATA * const CYCODE ADC_FlexSensor_R_AMux__addrTable[2] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE ADC_FlexSensor_R_AMux__maskTable[2] = {
	0x40u, 
	0x00u, 
};

/*******************************************************************************
* Function Name: ADC_FlexSensor_R_AMux_Set
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void ADC_FlexSensor_R_AMux_Set(uint8 channel)
{
	if (channel < 2)
	{
		*ADC_FlexSensor_R_AMux__addrTable[channel] |= ADC_FlexSensor_R_AMux__maskTable[channel];
	}
}

/*******************************************************************************
* Function Name: ADC_FlexSensor_R_AMux_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void ADC_FlexSensor_R_AMux_Unset(uint8 channel)
{
	if (channel < 2)
	{
		*ADC_FlexSensor_R_AMux__addrTable[channel] &= (uint8)~ADC_FlexSensor_R_AMux__maskTable[channel];
	}
}
